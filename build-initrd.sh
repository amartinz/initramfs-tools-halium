...
[ -z $INCHROOTPKGS ] && INCHROOTPKGS="initramfs-tools dctrl-tools dmsetup e2fsprogs f2fs-tools libc6-dev zlib1g-dev libssl-dev busybox-static parse-android-dynparts"
